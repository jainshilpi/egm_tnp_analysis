...
def loopTree(sample, isMC):
	...
	for p in sample.path:
		...
		#friendTreeName='weights_2017_runF'
                ...
                tree.AddFriend(friendTreeName,"/eos/cms/store/group/phys_egamma/swmukher/ntuple_2017_v2/PU/DPS/May8_2020/DY_madgraph_ele.pu.puTree.root")
...
mcSamples2017RC = {
	'runB'    : tnpSamples.Run17RC['DY_madgraph'].clone(),
	'runC'    : tnpSamples.Run17RC['DY_madgraph'].clone(),
	'runD'    : tnpSamples.Run17RC['DY_madgraph'].clone(),
	'runE'    : tnpSamples.Run17RC['DY_madgraph'].clone(),
	'runF'    : tnpSamples.Run17RC['DY_madgraph'].clone(),
	'runFull' : tnpSamples.Run17RC['DY_madgraph'].clone()
}
...
dataSamples2017RC = {
	'runB'    : tnpSamples.Run17RCAOD['data_Run2017BRC'].clone(),
	'runC'    : tnpSamples.Run17RCAOD['data_Run2017CRC'].clone(),
	'runD'    : tnpSamples.Run17RCAOD['data_Run2017DRC'].clone(),
	'runE'    : tnpSamples.Run17RCAOD['data_Run2017ERC'].clone(),
	'runF'    : tnpSamples.Run17RCAOD['data_Run2017FRC'].clone(),
	'runFull' : tnpSamples.Run17RCAOD['data_Run2017FullRC'].clone()
}


mcSamples2017RC = {
	'runB'    : tnpSamples.Run17RCAOD['DY_madgraph'].clone(),
	'runC'    : tnpSamples.Run17RCAOD['DY_madgraph'].clone(),
	'runD'    : tnpSamples.Run17RCAOD['DY_madgraph'].clone(),
	'runE'    : tnpSamples.Run17RCAOD['DY_madgraph'].clone(),
	'runF'    : tnpSamples.Run17RCAOD['DY_madgraph'].clone(),
	'runFull' : tnpSamples.Run17RCAOD['DY_madgraph'].clone()
}
