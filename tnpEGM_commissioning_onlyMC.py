...
#    if not sample.puTree is None:
       ...
       # tree.AddFriend(sample.weight.split('.')[0],sample.puTree)
        tree.AddFriend(friendTreeName,"/eos/cms/store/group/phys_egamma/swmukher/UL/ntuple_2017_UltraLegacy/PU_redo/DY_1j_madgraph_ele.pu.puTree.root")
...
#            continue;
        ...
        if isMC==1 and applyMCweight==True:
...
#        if not (tag_Ele_pt > 40 and tag_sc_abseta<2.5 and pair_mass>80 and pair_mass<100 and el_sc_abseta<1.4442 and el_et>20):
#        if not (tag_Ele_pt > 40 and tag_sc_abseta<1.4442 and pair_mass>80 and pair_mass<100 and el_sc_abseta<2.5 and el_et>20):
        if not (tag_Ele_pt > 40 and tag_sc_abseta<1.4442 and pair_mass>80 and pair_mass<100 and el_sc_abseta<2.5 and el_et>20):
#        if not (tag_Ele_pt > 40 and tag_sc_abseta<2.5 and pair_mass>80 and pair_mass<100 and el_sc_abseta<1.4442 and el_et>32):
            continue
